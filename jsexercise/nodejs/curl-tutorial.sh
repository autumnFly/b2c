...
#下载文件
curl -o /curl/pic.png https://www.csair.com/cn/new/images/headfoot.png

#以服务器文件名下载文件到本地
curl -O https://www.csair.com/cn/new/images/headfoot.png
...
#获取跳转后的内容
 curl -L https://b2c.csair.com/portal/ordermanage/planeOrder/queryPlaneOrders
