...
$(document).ready(function () {
    (function (inputUserId, inputPwdPH, inputPwd) {
        ...
        $("form#memberLogin").on("submit", function (e) {
            e.preventDefault();
            var inputList = Csair.Validation.validateForm($(this));
            var error = false;
            ...
            var obj = Csair.formUtils.getSubmitObjs($("form#memberLogin"));
            obj.jsonObj["loginType"] = 1;
            obj.jsonObj["memberType"] = 1;
            Csair.AjaxUtils.postJSON("/login/login", obj.jsonObj
                , function (result) {
    ...
    (function (tabTitle, divLogin, divGetCode) {
        tabTitle.click(function (event) {
            ...
            divGetCode.click(function () {
                ...
                var input = Csair.Validation.validateInput(inputDynamic);
                ...
                Csair.AjaxUtils.postJSON("/login/smsMessage/EUserVerifyCode", reqJsonObj
                    , function (result) {
                        divGetCode.removeClass("disabled");
