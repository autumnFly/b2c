...
insert into `spring_scheduled_cron`
values (2, 'com.csair.b2c.cloud.test.scheduled.dbtask.DbPrintTask', '*/5 * * * * ?', 'demo', 0);
insert into `spring_scheduled_cron`
values (3, 'com.csair.b2c.cloud.test.scheduled.dbtask.DbPrintTask1', '*/5 * * * * ?', 'demo1', 0);
insert into `spring_scheduled_cron`
values (4, 'com.csair.b2c.cloud.test.scheduled.dbtask.DbPrintTas2', '*/5 * * * * ?', 'demo2', 0);