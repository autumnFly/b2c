...
# 查看JVM已加载的类信息
sc org.javamaster.b2c.swagger2.controller*

# 打印类的详细信息
sc -d -f org.javamaster.b2c.swagger2.controller.LoginController

# 查看已加载类的方法信息
sm org.javamaster.b2c.swagger2.controller.LoginController

# 查看方法的详细信息
sm -d org.javamaster.b2c.swagger2.controller.LoginController

# 反编译class文件
jad org.javamaster.b2c.swagger2.controller.LoginController

# 查看类加载器
classloader -l
# 使用ClassLoader去加载类
classloader -c 439f5b3d --load /tmp/LoginController.class
...
redefine /tmp/LoginController.class

# 方法执行监控
monitor -c 5 org.javamaster.b2c.swagger2.controller.LoginController login
