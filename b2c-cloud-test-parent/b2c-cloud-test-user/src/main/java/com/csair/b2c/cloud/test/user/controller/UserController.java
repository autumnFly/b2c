package com.csair.b2c.cloud.test.user.controller;
...
import com.csair.b2c.cloud.test.user.constant.AuthorityConst;
...
public class UserController {
     ...
     * @return
     */
    @PreAuthorize("hasAuthority(T(com.csair.b2c.cloud.test.user.constant.AuthorityConst).ROLE_ADMIN) or #users.username == #userDetails.username")
