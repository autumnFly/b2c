...
import com.csair.b2c.test.mybatis.model.Address;
    ...
    @Results(
            {
                    ...
                    @Result(property = "address", column = "address_id"
                            , one = @One(select = "com.csair.b2c.test.mybatis.mapper.mysql.StudentAnnoMapper.findAddressById"))
            })
    ...
    @Results(
            {
                    ...
                    @Result(property = "courses", column = "tutor_id",
                            many = @Many(select = "com.csair.b2c.test.mybatis.mapper.mysql.StudentAnnoMapper.findCoursesByTutorId"))
            })
