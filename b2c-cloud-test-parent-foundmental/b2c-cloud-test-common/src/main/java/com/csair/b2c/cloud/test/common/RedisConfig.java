package com.csair.b2c.cloud.test.common;
...
//    @Value("${common.redis.hostName}")
    private String hostName = BlueMoonConsts.Local.REDIS_URL;
//    @Value("${common.redis.port}")
    private int port = BlueMoonConsts.Local.REDIS_PORT;
//    @Value("${common.redis.port}")
    private String password = BlueMoonConsts.Local.REDIS_PASSWORD;
