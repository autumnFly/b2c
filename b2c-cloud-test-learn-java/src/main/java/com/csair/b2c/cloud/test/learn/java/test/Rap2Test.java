...
import static com.csair.b2c.cloud.test.learn.java.utils.HeaderUtils.headers1;
import static com.csair.b2c.cloud.test.learn.java.utils.HeaderUtils.headers2;
import static com.csair.b2c.cloud.test.learn.java.utils.HeaderUtils.headers3;
import static com.csair.b2c.cloud.test.learn.java.utils.HeaderUtils.headers4;
...
public class Rap2Test {
    ...
    public void testCopyInterfaces() throws Exception {
        ...
        JSONObject originResJsonObject = executeGet("http://rap2api.bluemoon.com.cn/repository/get?id=" + originId, headers1(cookieValue)).getJSONObject("data");
        JSONObject targetResJsonObject = executeGet("http://rap2api.bluemoon.com.cn/repository/get?id=" + targetId, headers1(cookieValue)).getJSONObject("data");
    ...
    private int create(JSONObject newCreateJsonObj, String cookieValue) throws Exception {
        JSONObject resJsonObject = executePost(newCreateJsonObj, "http://rap2api.bluemoon.com.cn/interface/create", headers2(cookieValue)).getJSONObject("data");
    ...
    private int lock(int id, String cookieValue) throws Exception {
        ...
        JSONObject resJsonObject = executePost(jsonObject, "http://rap2api.bluemoon.com.cn/interface/lock", headers3(cookieValue)).getJSONObject("data");
    ...
    private JSONObject update(JSONObject updateCreateJsonObj, int newInterfaceId, String cookieValue) throws Exception {
        JSONObject resJsonObject = executePost(updateCreateJsonObj, "http://rap2api.bluemoon.com.cn/properties/update?itf=" + newInterfaceId, headers4(cookieValue)).getJSONObject("data");
    ...
    private boolean unlock(int id, String cookieValue) throws Exception {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("id", id);
        JSONObject resJsonObject = executePost(jsonObject, "http://rap2api.bluemoon.com.cn/interface/unlock", headers3(cookieValue)).getJSONObject("data");
