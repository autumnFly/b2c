...
import static org.javamaster.b2c.config.BlueMoonConsts.Micro.PASSWORD;
import static org.javamaster.b2c.config.BlueMoonConsts.Micro.URL;
import static org.javamaster.b2c.config.BlueMoonConsts.Micro.USERNAME;
...
public class MybatisUtils {
    ...
    public static DruidDataSource getDatasourceJdbcSakila() {
        ...
        dataSourceJdbcSakila = druidDataSource(URL_SAKILA, BlueMoonConsts.Local.USERNAME, BlueMoonConsts.Local.PASSWORD);
        return dataSourceJdbcSakila;
    }
    ...
    public static DruidDataSource getDatasourceJdbcWashMall() {
        ...
        dataSourceJdbcWashMall = druidDataSource(BlueMoonConsts.Honor.URL_WASH, BlueMoonConsts.WashingService.USERNAME, BlueMoonConsts.WashingService.PASSWORD);
        return dataSourceJdbcWashMall;
    }
