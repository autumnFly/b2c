package com.csair.b2c.cloud.test.learn.java.jdbc.impl;

import com.alibaba.druid.pool.DruidPooledConnection;
import com.csair.b2c.cloud.test.learn.java.jdbc.DatabaseService;
import com.csair.b2c.cloud.test.learn.java.jdbc.model.Column;
import com.csair.b2c.cloud.test.learn.java.jdbc.model.Database;
import com.csair.b2c.cloud.test.learn.java.jdbc.model.Table;
...
public class MysqlDatabaseServiceImpl implements DatabaseService {
    ...
    public MysqlDatabaseServiceImpl(DataSource dataSource) {
        ...
        connection = (JDBC4Connection) ((DruidPooledConnection) this.dataSource.getConnection()).getConnection();
    ...
    public List<Map<String, Object>> getTableData(String name, int size) {
        List<Map<String, Object>> list = jdbcTemplate.queryForList("select * from " + name + " limit ?", new Object[]{size});
        return list;
    }
}
