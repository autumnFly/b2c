...
/**
 * <p>MemberInfoForB2CDto complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="MemberInfoForB2CDto"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "MemberInfoForB2CDto", namespace = "http://dto.services.cbdinterface.cbd.csair.com", propOrder = {
    "accountStatus",
    "activeStatus",
    "businessChanel",
    "certificates",
...
public class MemberInfoForB2CDto {
    ...
    @XmlElementRef(name = "businessChanel", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> businessChanel;
    @XmlElementRef(name = "certificates", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfSvcPcCertificateDto> certificates;
    @XmlElementRef(name = "cnName", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cnName;
    @XmlElementRef(name = "enFirstName", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> enFirstName;
    @XmlElementRef(name = "enLastName", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> enLastName;
    @XmlElementRef(name = "enName", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> enName;
    @XmlElementRef(name = "exchangeMileage", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> exchangeMileage;
    @XmlElementRef(name = "exchangeOrderId", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> exchangeOrderId;
    @XmlElementRef(name = "havePassword", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> havePassword;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar joinDate;
    protected Integer loyaltyId;
    @XmlElementRef(name = "loyaltyNmae", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "title", namespace = "http://dto.services.cbdinterface.cbd.csair.com", type = JAXBElement.class, required = false)
