...
/**
 * <p>MemberExchangeInfoForVOSDto complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="MemberExchangeInfoForVOSDto"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "MemberExchangeInfoForVOSDto", namespace = "http://dto.services.marketing.cbd.csair.com", propOrder = {
    "accountStatus",
    "activeStatus",
    "businessChanel",
    "certificates",
...
public class MemberExchangeInfoForVOSDto {
