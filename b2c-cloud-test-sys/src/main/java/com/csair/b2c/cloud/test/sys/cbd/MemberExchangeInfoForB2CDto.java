...
/**
 * <p>MemberExchangeInfoForB2CDto complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="MemberExchangeInfoForB2CDto"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "MemberExchangeInfoForB2CDto", namespace = "http://dto.services.marketing.cbd.csair.com", propOrder = {
    "accountStatus",
    "activeStatus",
    "businessChanel",
    "certificates",
...
public class MemberExchangeInfoForB2CDto {
    ...
    @XmlElementRef(name = "title", namespace = "http://dto.services.marketing.cbd.csair.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> title;
    protected Double totalMileage;
    @XmlElementRef(name = "uid", namespace = "http://dto.services.marketing.cbd.csair.com", type = JAXBElement.class, required = false)
